...
public class MsgTree 
{
	...
	private static int staticCharIndex = 0;
	...
	public MsgTree(String encodingString) {
		...
		// Create a stack to keep track of MsgTree nodes
		// Initialize index to 0 and set the payloadChar of
		//the current MsgTree to the first character of encodingString
		// Push the current MsgTree onto the stack
		// Initialize a variable 'cur' to the current MsgTree
		// Initialize a variable 'lastOpt' to "in"
		...
		MsgTree cur = this;
		String lastOpt = "in";
		// Loop through the characters in encodingString starting from the second character
		while (index < encodingString.length()) 
		{
			// Create a new MsgTree node with the current character at the 'index'
			MsgTree node = new MsgTree(encodingString.charAt(index++));
			
			// Check the value of 'lastOpt' to determine the next operation
	...
	/**
	 * Extra credit for statistics. 
	 * Pulls the encoded and decoded strings data to print
	 * 
	 * @param encodeStr
	 * @param decodeStr
	 */
